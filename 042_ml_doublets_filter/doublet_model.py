...
train_data = Dataset(train_fname).filter('isFlippedIn', 1.0).filter('isFlippedOut', 1.0).filter('detSeqIn', 0.0).filter('detSeqOut', 1.0) #.balance_data()
val_data = Dataset(val_fname).filter('isFlippedIn', 1.0).filter('isFlippedOut', 1.0).filter('detSeqIn', 0.0).filter('detSeqOut', 1.0)
test_data = Dataset(test_fname).filter('isFlippedIn', 1.0).filter('isFlippedOut', 1.0).filter('detSeqIn', 0.0).filter('detSeqOut', 1.0)
