...
train_data = Dataset(dataset.trainfiles[:20]) if not (DEBUG or not PU35) else Dataset(train_fname)
val_data = Dataset(dataset.trainfiles[20:30]) if not (DEBUG or not PU35) else Dataset(val_fname)
test_data = Dataset(dataset.trainfiles[30:40]) if not (DEBUG or not PU35) else Dataset(test_fname)
